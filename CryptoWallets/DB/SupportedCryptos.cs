//------------------------------------------------------------------------------
// Clase SupportedCryptos generada automáticamente con CrearClaseSQL
// de la tabla 'SupportedCryptos' de la base 'CryptoWallets'
// Fecha: 24/Jan/2025 00:34:01
//
...
public class SupportedCryptos{
    ...
    public static DataTable Tabla(string sel){
        // devuelve una tabla con los datos de la tabla SupportedCryptos
        SqlDataAdapter da;
    ...
    public override string Actualizar(string sel){
        ...
        //sCommand = "UPDATE SupportedCryptos SET CryptoID = @CryptoID, Name = @Name, Abbreviation = @Abbreviation, Description = @Description, CreatedAt = @CreatedAt, UpdatedAt = @UpdatedAt, DeletedAt = @DeletedAt, AppID = @AppID, Platform = @Platform,  ! es = @ ! es, WalletID = @WalletID, WalletName = @WalletName, ApplicationID = @ApplicationID, AddressID = @AddressID, PublicKey = @PublicKey, PrivateKey = @PrivateKey, SeedID = @SeedID, Phrase = @Phrase  WHERE (ID = @ID)";
    ...
    public override string Crear(){
        ...
        ////       Yo compruebo que sea un campo llamado ID, pero en tu caso puede ser otro
        //sCommand = "INSERT INTO SupportedCryptos (Name, Abbreviation, Description, CreatedAt, UpdatedAt, DeletedAt, Platform,  ! es, WalletName, ApplicationID, PublicKey, PrivateKey, Phrase)  VALUES(@Name, @Abbreviation, @Description, @CreatedAt, @UpdatedAt, @DeletedAt, @Platform, @ ! es, @WalletName, @ApplicationID, @PublicKey, @PrivateKey, @Phrase) ";
    ...
    /// <summary>
    ///  Devuelve una colección de SupportedCryptos según la cadena select.
    /// </summary>
    public static List(Of SupportedCryptos) TablaCol(string sel){
        List(Of SupportedCryptos) col = new List(Of SupportedCryptos);
    ...
    public static SupportedCryptos Reader2Tipo(SqlDataReader r){
        ...
        o_SupportedCryptos.Name = r["Name"].ToString();
        o_SupportedCryptos.Abbreviation = r["Abbreviation"].ToString();
        o_SupportedCryptos.Description = r["Description"].ToString();
        o_SupportedCryptos.CreatedAt = ConversorTipos.DateTimeData(r["CreatedAt"].ToString());
        o_SupportedCryptos.UpdatedAt = ConversorTipos.DateTimeData(r["UpdatedAt"].ToString());
        o_SupportedCryptos.DeletedAt = ConversorTipos.DateTimeData(r["DeletedAt"].ToString());
        o_SupportedCryptos.AppID = ConversorTipos.Int32Data(r["AppID"].ToString());
        o_SupportedCryptos.Platform = r["Platform"].ToString();
        o_SupportedCryptos.Notes = r[" ! es"].ToString();
        o_SupportedCryptos.WalletID = ConversorTipos.Int32Data(r["WalletID"].ToString());
        o_SupportedCryptos.WalletName = r["WalletName"].ToString();
        o_SupportedCryptos.ApplicationID = ConversorTipos.Int32Data(r["ApplicationID"].ToString());
        o_SupportedCryptos.AddressID = ConversorTipos.Int32Data(r["AddressID"].ToString());
        o_SupportedCryptos.PublicKey = r["PublicKey"].ToString();
        //o_SupportedCryptos.PrivateKey = r["PrivateKey"];
        o_SupportedCryptos.SeedID = ConversorTipos.Int32Data(r["SeedID"].ToString());
        o_SupportedCryptos.Phrase = r["Phrase"].ToString();
